...
public class GetByNameQueryHandlerTests
{
    ...
    public async Task Handle_ShouldReturnListOfMobileFoodFacility_WhenApplicantExists()
    {
        ...
        expectedFoodFacilities.Add(new MobileFoodFacility { LocationId = 1, Applicant = "ApplicantName" });
        expectedFoodFacilities.Add(new MobileFoodFacility { LocationId = 2, Applicant = "ApplicantName" });
